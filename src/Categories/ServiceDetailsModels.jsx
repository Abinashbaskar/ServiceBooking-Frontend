...
const ServiceDetailsModels = ({ service, isOpen, onClose }) => {
  ...
  return (
    <Modal
      ...
      overlayClassName="fixed inset-0 flex items-center justify-center p-4 z-50"
      className="bg-white rounded-3xl max-w-4xl w-full max-h-[100vh] overflow-y-auto shadow-2xl relative outline-none"
    >
      {/* Close Button */}
      <button
        onClick={onClose}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-8">
              <button className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-blue-500 text-white rounded-lg font-medium hover:bg-blue-600 transition-colors text-[14px]">
